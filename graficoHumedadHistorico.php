...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        En este grafico podemos ver las variaciones de la humedad en el tiempo
    <br>
  
    <a href="http://secym.000webhostapp.com/secym/formularioGraficoHumedad.html">
...
$queryTemp="SELECT UNIX_TIMESTAMP(fechaRegistro), `humedad` FROM `historico` WHERE YEAR(fechaRegistro)='$ano' AND MONTH(fechaRegistro)='$mes' AND DAY(fechaRegistro)='$dia'AND `dispositivo`='$dispositivo';";
...
Highcharts.chart('container', {
    ...
    subtitle: {
        text: 'Grafico Historico de Humedad'
    },
    xAxis: {
        type:'datetime'
